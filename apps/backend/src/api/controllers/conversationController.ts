 ...
 */
const updateConversationMetadata = async (req: Request, res: Response) => {
  try {
    const { sessionId } = req.params;
 ...
 */
const getConversationMetrics = async (req: Request, res: Response) => {
  try {
 ...
 */
const testClaudeIntegration = async (req: Request, res: Response) => {
  try {
