...
import { z } from 'zod';
// Define enums from our Drizzle schema instead of Prisma
const Gender = ['male', 'female', 'non_binary', 'prefer_not_to_say'] as const;
const ExperienceLevel = ['beginner', 'intermediate', 'advanced', 'professional'] as const;
const AvailabilityStatus = ['available', 'busy', 'unavailable'] as const;
const UnionStatus = ['union', 'non_union', 'fi_core'] as const;
