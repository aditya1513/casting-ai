...
describe('Quick Actions Integration Tests - API Endpoint Switching', () => {
  ...
  describe('Authenticated User Flow', () => {
    ...
    it('should fallback to public endpoint when protected endpoint fails', async () => {
      ...
      mockFetch.mockRejectedValueOnce(new Error('Auth failed: 401')).mockResolvedValueOnce({
        ok: true,
        json: async () => ({
      ...
      expect(mockFetch).toHaveBeenCalledWith('/api/conversations/messages', expect.any(Object));
    });
  });
