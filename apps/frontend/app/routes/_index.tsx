...
// Temporarily disabled Navigation import
// import { Navigation } from "~/components/layout/navigation";

export const meta: MetaFunction = () => {
  return [
    { title: "CastMatch - Mumbai's Premier Casting Platform" },
    { name: "description", content: "Connecting talent with opportunity in the OTT revolution" },
  ];
};
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm">
                  <li><Link to="/actors" className="hover:text-white">For Actors</Link></li>
                  <li><Link to="/casting-directors" className="hover:text-white">For Casting Directors</Link></li>
                  <li><Link to="/producers" className="hover:text-white">For Producers</Link></li>
                </ul>
              </div>
              <div>
                <h4 className="text-white text-sm font-semibold uppercase tracking-wider mb-4">
