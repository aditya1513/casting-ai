      ...
      >
        <div className="px-2 pt-2 pb-3 space-y-1 bg-slate-800/80 backdrop-blur-xl">
          ...
          <div className="border-t border-slate-600 mt-4 pt-4 px-2">
            <button 
              className="flex items-center w-full px-3 py-3 text-base font-medium text-slate-300 hover:bg-slate-700/60 hover:text-white transition-all duration-200 rounded-lg"
              onClick={closeMobileMenu}
            >
