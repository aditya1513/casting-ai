...
export const meta: MetaFunction = () => [
  ...
  { name: "description", content: "Connect actors with casting directors for OTT projects in Mumbai. Find your next role or discover talent for your production." },
  ...
  { property: "og:description", content: "AI-powered casting platform for Mumbai's entertainment industry" },
  ...
  { name: "twitter:description", content: "AI-powered casting platform for Mumbai's entertainment industry" },
...
// export const ErrorBoundary = V2_ClerkErrorBoundary; // Disabled for now
